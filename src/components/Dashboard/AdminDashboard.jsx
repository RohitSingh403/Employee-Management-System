    ...
    <div className="h-screen w-full bg-gradient-to-r from-[#f7d7da] via-[#f2e7e1] to-[#e8eadf]">
      ...
      <div className=" h-140 w-248 border-[2px] border-white rounded-3xl mt-5 pl-10 ml-10 flex flex-col mb-10  ">
        ...
        <form>
          ...
          <textarea className="border mt-1 border rounded-xl p-2 w-[80%]" name="" id=""></textarea>
          ...
          <button className=" ml-10 cursor-pointer border p-2 text-white rounded-xl bg-[#ff003d]">Create Task</button>
        </form>
      </div>
    </div>
  );
